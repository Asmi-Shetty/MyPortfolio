...
// import facialLandmarkImg from "../assets/avijo_project_image.png"; // Ensure this image path is correct
...
import React from "react";
import { Github, ExternalLink } from "lucide-react";
import avijoProject from "../assets/avijo_project_image.png"; // Project 1 image
import eduhive from "../assets/eduhive_project_image.png"; // Replace with your 2nd project's image path
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col md:flex-row gap-10 items-start mb-28">
          ...
          <div className="md:w-1/2 w-full flex flex-col items-start relative z-10">
            ...
            <h3 className="text-2xl sm:text-3xl font-bold text-[#ccd6f6] mb-6">
              Eduhive-Collaborative Study Platform
            </h3>
